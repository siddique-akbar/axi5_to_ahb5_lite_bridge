...
#set_property -dict { PACKAGE_PIN L16   IOSTANDARD LVCMOS33 } [get_ports { rx_data }]; #IO_L3N_T0_DQS_EMCCLK_14 Sch=sw[1]
...
#set_property -dict { PACKAGE_PIN V14   IOSTANDARD LVCMOS33 } [get_ports { tx_data }]; #IO_L22N_T3_A04_D20_14 Sch=led[13]
